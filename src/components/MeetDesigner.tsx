        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-12 lg:p-24 flex flex-col justify-center bg-white">
              <span className="text-brand font-bold tracking-[0.3em] uppercase text-xs mb-6">The Visionary</span>
              ...
              <div className="flex items-center gap-4 mb-12">
                <a 
                  ...
                  className="w-14 h-14 rounded-2xl bg-stone-50 flex items-center justify-center text-stone-600 hover:bg-brand hover:text-white hover:shadow-lg hover:shadow-brand/20 transition-all duration-300"
                >
                  <Instagram size={22} />
                </a>
                <a 
              ...
              <div className="pt-10 border-t border-stone-100">
                ...
                <p className="text-stone-900 font-serif text-2xl">Prinblec Interior Studio</p>
              </div>
            </div>
          </div>
        </motion.div>

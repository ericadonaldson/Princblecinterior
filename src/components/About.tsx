        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-6 text-stone-600 text-lg leading-relaxed">
              <p>
                At Lumina Decor, we believe that your home should be a reflection of your journey, your tastes, and your aspirations. We don't just follow trends; we create timeless environments that resonate with the people who live in them.
              </p>
              <p>

      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="absolute -bottom-8 -right-8 w-72 h-72 bg-brand-50 rounded-[3rem] -z-0 hidden md:block" />
            <div className="absolute -top-8 -left-8 w-40 h-40 border-2 border-brand/30 rounded-full -z-0 hidden md:block animate-pulse" />
          </motion.div>
          ...
          <motion.div 
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="text-sm font-bold tracking-widest uppercase text-brand mb-4">Our Philosophy</h2>
